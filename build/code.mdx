...
To determine the success of a experiment, we track multiple data points on [Results](/build/results). Simply add a `client-reference-id` to your Stripe Checkout Session
...
metadata: { 1price_cid: req.body.referral, },
items: [
