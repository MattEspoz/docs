...
<ParamField path="Paid Customers">Users that subscribe to your plan</ParamField>
...
<ParamField path="Churned Subscribers">
  The number of customers who were previous subscribers but have sinced
  cancelled their plan (note: relevant for one-time products)
</ParamField>
